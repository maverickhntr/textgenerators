# -*- coding: utf-8 -*-
"""
Created on Wed Feb 14 15:51:25 2018
...
#!/usr/bin/python
# Full Potential
# A 1k story generator (excluding comments) that uses only lines from The Matrix screenplay (pg. 112-113, 122-123)
...
'They freeze in a kind of embrace; her sweating, panting, The Wolf machine-calm.',
'The Wolf smiles.',
...
'All stare transfixed with awe as the scrolling code accelerates, faster and faster, as if the machine language was unable to keep up or perhaps describe what is happening.',
...
'She turns and faces the remaining Agents.',
'The Wolves look at each other...They run.']
text.sort()
while len(text) > 6:
